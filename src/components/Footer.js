  ...
  return (
    <>
      <div className="footer flex flex-col max-w-[1440px] ">
        ...
        <div className="flex flex-wrap justify-center items-center max-w-[1440px] ">
          <div className="container justify-between flex flex-wrap max-w-[1050px] py-12">
            <ul>
        ...
        <div className="flex justify-center items-center max-w-[1440px] py-6 bg-verylightgray3 " >
          <p className="container text-lightgray bg-verylightgray3 max-w-[1050px]  ">
